...
//    @GetMapping("/currency-converters/from/{from}/to/{to}/quantity/{quantity}")
//    public CurrencyConversionBean getConvertedCurrencyNormal(@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity) {
//
